...
function parseNBASeason(filename="games1314.xlsx", data_dir="../data")
	###
	# Parse real data
	###
	...
	## Prepare output
	avg_eliminated_by_game = zeros(Float64, num_games)
	...
	critical_game = zeros(num_teams,3) # [ crit game, # wins @ crit, # losses @ crit ]
	...
	for row = start_row:num_rows
		...
		avg_eliminated_by_game[game_ind] = num_eliminated
	...
	window_size = 10; # ?
	num_windows = num_team_games - window_size + 1;
	return
end # parse
