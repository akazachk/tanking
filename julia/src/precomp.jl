...
precompile(Tuple{typeof(Tanking.include), String})
...
precompile(Tuple{getfield(JuMP, Symbol("#48#50")), Expr})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#48#50")), Array{Expr, 1}})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#49#51")), Array{Expr, 1}})
precompile(Tuple{typeof(JuMP._extract_kw_args), Tuple{Expr}})
...
precompile(Tuple{getfield(JuMP, Symbol("#58#66")), Expr})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#58#66")), Array{Expr, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#59#67")), Expr})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#59#67")), Array{Expr, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#60#68")), Expr})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#60#68")), Array{Expr, 1}})
...
precompile(Tuple{typeof(JuMP._get_name), Expr})
...
precompile(Tuple{typeof(Base._any), getfield(JuMP, Symbol("#61#69")), Array{Expr, 1}, Base.Colon})
precompile(Tuple{typeof(Base._any), getfield(JuMP, Symbol("#62#70")), Array{Expr, 1}, Base.Colon})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#63#71")), Array{Expr, 1}})
precompile(Tuple{typeof(Base.iterate), Array{Expr, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#64#72")), Expr})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#64#72")), Array{Expr, 1}})
...
precompile(Tuple{typeof(JuMP._build_ref_sets), Expr, Symbol})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{Expr, Array{Any, 1}, Array{Any, 1}, Expr}, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{Expr, Array{Any, 1}, Array{Any, 1}, Expr}, Int64, Int64})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(JuMP._expr_is_splat), Tuple{Array{Any, 1}}})
precompile(Tuple{typeof(JuMP._expr_is_splat), Expr})
precompile(Tuple{typeof(Base.throw_boundserror), Base.Broadcast.Broadcasted{Nothing, Tuple{Base.OneTo{Int64}}, typeof(JuMP._expr_is_splat), Tuple{Base.Broadcast.Extruded{Array{Any, 1}, Tuple{Bool}, Tuple{Int64}}}}, Tuple{Int64}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(JuMP._expr_is_splat), Tuple{Array{Any, 1}}}})
...
precompile(Tuple{typeof(Base.collect_to!), Array{Expr, 1}, Base.Generator{Array{Any, 1}, getfield(JuMP.Containers, Symbol("#17#18"))}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Any, 1}, getfield(JuMP.Containers, Symbol("#17#18"))}})
precompile(Tuple{typeof(JuMP.Containers.generate_container), Expr, Array{Any, 1}, Array{Any, 1}, Symbol})
...
precompile(Tuple{getfield(JuMP, Symbol("##_get_looped_code#47")), Bool, typeof(JuMP._get_looped_code), Symbol, Expr, Expr, Array{Any, 1}, Array{Any, 1}, Expr, Symbol})
precompile(Tuple{typeof(JuMP._get_looped_code), Symbol, Expr, Expr, Array{Any, 1}, Array{Any, 1}, Expr, Symbol})
precompile(Tuple{typeof(Base.:(==)), Symbol, Symbol})
precompile(Tuple{Type{NamedTuple{(:final_variable, :model_for_registering), T} where T<:Tuple}, Tuple{Symbol, Expr}})
precompile(Tuple{typeof(JuMP._macro_return), Expr, Symbol})
precompile(Tuple{getfield(JuMP, Symbol("##_macro_assign_and_return#52")), Symbol, Expr, typeof(JuMP._macro_assign_and_return), Expr, Symbol, Symbol})
precompile(Tuple{getfield(JuMP, Symbol("#_macro_assign_and_return##kw")), NamedTuple{(:final_variable, :model_for_registering), Tuple{Symbol, Expr}}, typeof(JuMP._macro_assign_and_return), Expr, Symbol, Symbol})
...
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#48#50")), Array{Any, 1}})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#49#51")), Array{Any, 1}})
precompile(Tuple{typeof(JuMP._extract_kw_args), Tuple{Expr, Symbol}})
precompile(Tuple{getfield(JuMP, Symbol("#48#50")), Symbol})
...
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#58#66")), Array{Any, 1}})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#59#67")), Array{Any, 1}})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#60#68")), Array{Any, 1}})
...
precompile(Tuple{getfield(JuMP, Symbol("#_error#65")){Tuple{Symbol, Expr, Symbol}}, String})
precompile(Tuple{typeof(JuMP._set_lower_bound_or_error), getfield(JuMP, Symbol("#_error#65")){Tuple{Symbol, Expr, Symbol}}, JuMP._VariableInfoExpr, Int64})
precompile(Tuple{typeof(JuMP._set_upper_bound_or_error), getfield(JuMP, Symbol("#_error#65")){Tuple{Symbol, Expr, Symbol}}, JuMP._VariableInfoExpr, Int64})
...
precompile(Tuple{typeof(Base._any), getfield(JuMP, Symbol("#61#69")), Array{Any, 1}, Base.Colon})
precompile(Tuple{getfield(JuMP, Symbol("#61#69")), Symbol})
precompile(Tuple{typeof(Base._any), getfield(JuMP, Symbol("#62#70")), Array{Any, 1}, Base.Colon})
precompile(Tuple{getfield(JuMP, Symbol("#62#70")), Symbol})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#63#71")), Array{Any, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#63#71")), Symbol})
precompile(Tuple{typeof(JuMP._set_integer_or_error), getfield(JuMP, Symbol("#_error#65")){Tuple{Symbol, Expr, Symbol}}, JuMP._VariableInfoExpr})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#64#72")), Array{Any, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#64#72")), Symbol})
...
precompile(Tuple{getfield(JuMP, Symbol("#_error#53")){Symbol}, String})
...
precompile(Tuple{typeof(JuMP._extract_kw_args), Tuple{Symbol, Expr}})
precompile(Tuple{typeof(JuMP._get_name), Symbol})
precompile(Tuple{typeof(JuMP._build_ref_sets), Symbol, Symbol})
precompile(Tuple{Type{Base.Val{:in}}})
precompile(Tuple{typeof(JuMP.parse_constraint), Function, Symbol, Expr, Int64})
precompile(Tuple{Type{Base.Val{:==}}})
precompile(Tuple{typeof(Base.mapreduce_impl), typeof(JuMP._is_complex_expr), typeof(Base.:(+)), Array{Any, 1}, Int64, Int64, Int64})
precompile(Tuple{typeof(Base._mapreduce), typeof(JuMP._is_complex_expr), typeof(Base.:(+)), Base.IndexLinear, Array{Any, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#43#45")){Expr}, Int64})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Expr, 1}, Expr, Base.Generator{Base.UnitRange{Int64}, getfield(JuMP, Symbol("#43#45")){Expr}}, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.UnitRange{Int64}, getfield(JuMP, Symbol("#43#45")){Expr}}})
...
precompile(Tuple{getfield(JuMP, Symbol("#44#46")){Expr}, Int64})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Expr, 1}, Expr, Base.Generator{Base.UnitRange{Int64}, getfield(JuMP, Symbol("#44#46")){Expr}}, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.UnitRange{Int64}, getfield(JuMP, Symbol("#44#46")){Expr}}})
precompile(Tuple{typeof(JuMP._parse_expr), Expr, Symbol, Array{Any, 1}, Array{Any, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#39#40")){Symbol, Array{Any, 1}, Array{Any, 1}}, Expr})
precompile(Tuple{typeof(JuMP._parse_gen), Expr, getfield(JuMP, Symbol("#39#40")){Symbol, Array{Any, 1}, Array{Any, 1}}})
precompile(Tuple{typeof(JuMP._parse_generator_sum), Expr, Symbol, Array{Any, 1}, Array{Any, 1}, Symbol})
precompile(Tuple{typeof(JuMP._parse_generator), Expr, Symbol, Array{Any, 1}, Array{Any, 1}, Symbol})
precompile(Tuple{typeof(JuMP._error_curly), Expr})
precompile(Tuple{typeof(JuMP._is_comparison), Expr})
precompile(Tuple{typeof(JuMP._parse_expr), Expr, Symbol, Array{Any, 1}, Array{Any, 1}, Symbol})
precompile(Tuple{typeof(JuMP.parse_one_operator_constraint), Function, Bool, Base.Val{:in}, Expr, MathOptInterface.EqualTo{Float64}})
precompile(Tuple{typeof(JuMP.parse_one_operator_constraint), Function, Bool, Base.Val{:==}, Expr, Int64})
precompile(Tuple{typeof(JuMP._parse_expr), Symbol, Symbol, Array{Any, 1}, Array{Any, 1}})
precompile(Tuple{typeof(JuMP._parse_expr), Symbol, Symbol, Array{Any, 1}, Array{Any, 1}, Symbol})
precompile(Tuple{typeof(Base.__cat), Array{Any, 1}, Tuple{Int64}, Tuple{Bool}, Float64, Vararg{Any, N} where N})
...
precompile(Tuple{typeof(Base.fill!), Base.SubArray{Any, 1, Array{Any, 1}, Tuple{Base.UnitRange{Int64}}, true}, Float64})
...
precompile(Tuple{typeof(JuMP._parse_expr), Int64, Symbol, Array{Any, 1}, Array{Any, 1}, Symbol})
...
precompile(Tuple{getfield(JuMP, Symbol("#_error#65")){Tuple{Symbol, Expr}}, String})
precompile(Tuple{typeof(JuMP._set_lower_bound_or_error), getfield(JuMP, Symbol("#_error#65")){Tuple{Symbol, Expr}}, JuMP._VariableInfoExpr, Int64})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Symbol, Expr, Expr, Expr, Expr}}})
precompile(Tuple{typeof(Base.getindex), Tuple{Symbol, Expr, Expr, Expr, Expr}, Base.UnitRange{Int64}})
precompile(Tuple{typeof(JuMP._extract_kw_args), Tuple{Expr, Expr, Expr, Expr}})
precompile(Tuple{typeof(JuMP._esc_non_constant), Int64})
precompile(Tuple{typeof(Base.similar), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(JuMP._keywordify), Tuple{Base.Broadcast.Extruded{Array{Expr, 1}, Tuple{Bool}, Tuple{Int64}}}}, Type{Tuple{Symbol, Int64}}})
precompile(Tuple{typeof(Base.setindex!), Array{Tuple{Symbol, Int64}, 1}, Tuple{Symbol, Int64}, Int64})
precompile(Tuple{typeof(Base.similar), Array{Tuple{Symbol, Int64}, 1}, Type})
precompile(Tuple{typeof(Base.Broadcast.copyto_nonleaf!), Array{Tuple{Symbol, Int64}, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(JuMP._keywordify), Tuple{Base.Broadcast.Extruded{Array{Expr, 1}, Tuple{Bool}, Tuple{Int64}}}}, Base.OneTo{Int64}, Int64, Int64})
precompile(Tuple{typeof(JuMP._esc_non_constant), Bool})
precompile(Tuple{Type{Array{Tuple{Symbol, Integer}, 1}}, UndefInitializer, Int64})
precompile(Tuple{typeof(Base.similar), Array{Tuple{Symbol, Integer}, 1}, Type})
precompile(Tuple{typeof(Base.Broadcast.copyto_nonleaf!), Array{Tuple{Symbol, Integer}, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(JuMP._keywordify), Tuple{Base.Broadcast.Extruded{Array{Expr, 1}, Tuple{Bool}, Tuple{Int64}}}}, Base.OneTo{Int64}, Int64, Int64})
precompile(Tuple{typeof(Base.Broadcast.restart_copyto_nonleaf!), Array{Tuple{Symbol, Integer}, 1}, Array{Tuple{Symbol, Int64}, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(JuMP._keywordify), Tuple{Base.Broadcast.Extruded{Array{Expr, 1}, Tuple{Bool}, Tuple{Int64}}}}, Tuple{Symbol, Bool}, Int64, Base.OneTo{Int64}, Int64, Int64})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, Array{Tuple{Symbol, Integer}, 1}})
precompile(Tuple{Type{NamedTuple{(:lower_bound, :upper_bound, :integer), T} where T<:Tuple}, Tuple{Int64, Int64, Bool}})
precompile(Tuple{typeof(Base.isempty), NamedTuple{(:lower_bound, :upper_bound, :integer), Tuple{Int64, Int64, Bool}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:lower_bound, :upper_bound, :integer), Tuple{Int64, Int64, Bool}}, Type{JuMP._VariableInfoExpr}})
precompile(Tuple{typeof(JuMP.parse_variable), Function, JuMP._VariableInfoExpr, Symbol, Symbol, Int64})
precompile(Tuple{typeof(JuMP.parse_one_operator_variable), Function, JuMP._VariableInfoExpr, Base.Val{:==}, Int64})
precompile(Tuple{typeof(JuMP._fix_or_error), getfield(JuMP, Symbol("#_error#65")){Tuple{Symbol, Expr}}, JuMP._VariableInfoExpr, Int64})
precompile(Tuple{typeof(Base.in), Symbol, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol}})
precompile(Tuple{typeof(JuMP._has_assignment_in_ref), Expr})
precompile(Tuple{typeof(Base._any), typeof(JuMP._has_assignment_in_ref), Array{Any, 1}, Base.Colon})
precompile(Tuple{typeof(JuMP._has_assignment_in_ref), Symbol})
precompile(Tuple{typeof(JuMP.parse_one_operator_constraint), Function, Bool, Base.Val{:in}, Expr, MathOptInterface.GreaterThan{Float64}})
precompile(Tuple{typeof(JuMP.parse_one_operator_constraint), Function, Bool, Base.Val{:>=}, Expr, Expr})
precompile(Tuple{typeof(JuMP.parse_one_operator_constraint), Function, Bool, Base.Val{:>=}, Expr, Int64})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#48#50")), Array{Symbol, 1}})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#49#51")), Array{Symbol, 1}})
precompile(Tuple{typeof(JuMP._extract_kw_args), Tuple{Symbol}})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{Array{Symbol, 1}, Array{Symbol, 1}, Symbol}, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{Array{Symbol, 1}, Array{Symbol, 1}, Symbol}, Int64, Int64})
precompile(Tuple{typeof(Base.popfirst!), Array{Symbol, 1}})
precompile(Tuple{typeof(Base.filter), typeof(JuMP._is_info_keyword), Array{Symbol, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#58#66")), Symbol})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#58#66")), Array{Symbol, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#59#67")), Symbol})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#59#67")), Array{Symbol, 1}})
precompile(Tuple{getfield(JuMP, Symbol("#60#68")), Symbol})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#60#68")), Array{Symbol, 1}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(JuMP._keywordify), Tuple{Array{Symbol, 1}}})
precompile(Tuple{typeof(Base.throw_boundserror), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(JuMP._keywordify), Tuple{Base.Broadcast.Extruded{Array{Symbol, 1}, Tuple{Bool}, Tuple{Int64}}}}, Tuple{Int64}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(JuMP._keywordify), Tuple{Array{Symbol, 1}}}})
precompile(Tuple{typeof(Base.getindex), Array{Union{}, 1}, Int64})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, Array{Union{}, 1}})
precompile(Tuple{typeof(Base.isempty), Array{Symbol, 1}})
precompile(Tuple{typeof(Base.any), Function, Array{Symbol, 1}})
precompile(Tuple{getfield(Base, Symbol("##any#592")), Function, typeof(Base.any), Function, Array{Symbol, 1}})
precompile(Tuple{typeof(Base._any), getfield(JuMP, Symbol("#61#69")), Array{Symbol, 1}, Base.Colon})
precompile(Tuple{typeof(Base._any), getfield(JuMP, Symbol("#62#70")), Array{Symbol, 1}, Base.Colon})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#63#71")), Array{Symbol, 1}})
precompile(Tuple{typeof(Base.filter), getfield(JuMP, Symbol("#64#72")), Array{Symbol, 1}})
...
precompile(Tuple{typeof(JuMP._add_kw_args), Expr, Array{Symbol, 1}})
precompile(Tuple{typeof(JuMP._constraint_macro), Tuple{Symbol, Symbol, Expr}, Symbol, Function})
precompile(Tuple{typeof(Base._collect), Base.UnitRange{Int64}, Tuple{Symbol, Symbol, Expr}, Base.HasEltype, Base.HasLength})
precompile(Tuple{typeof(JuMP._extract_kw_args), Tuple{Symbol, Symbol, Expr}})
precompile(Tuple{typeof(JuMP.parse_constraint), Function, Symbol, Symbol, Expr})
precompile(Tuple{typeof(JuMP.parse_one_operator_constraint), Function, Bool, Base.Val{:==}, Symbol, Expr})
...
precompile(Tuple{typeof(JuMP._parse_expr_toplevel), Symbol, Symbol})
...
precompile(Tuple{typeof(JuMP.parse_one_operator_constraint), Function, Bool, Base.Val{:in}, Expr, MathOptInterface.LessThan{Float64}})
precompile(Tuple{typeof(JuMP.parse_one_operator_constraint), Function, Bool, Base.Val{:<=}, Expr, Symbol})
precompile(Tuple{getfield(Base.Enums, Symbol("#@enum")), LineNumberNode, Module, Any, Vararg{Any, N} where N})
precompile(Tuple{Type{Tanking.MODE_TYPES}, Int32})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(Tanking, Symbol("#30#31")), Base.UnitRange{Int64}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.UnitRange{Int64}, getfield(Tanking, Symbol("#30#31"))}})
...
precompile(Tuple{typeof(Base.vcat), Base.Rational{Int64}, Base.Rational{Int64}, Base.Rational{Int64}, Vararg{Number, N} where N})
precompile(Tuple{typeof(Base.promote_typeof), Base.Rational{Int64}, Base.Rational{Int64}, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.promote_typeof), Base.Rational{Int64}, Int64})
precompile(Tuple{Type{Array{Base.Rational{Int64}, 1}}, UndefInitializer, Int64})
precompile(Tuple{typeof(Base.hvcat_fill), Array{Base.Rational{Int64}, 1}, Tuple{Base.Rational{Int64}, Base.Rational{Int64}, Base.Rational{Int64}, Base.Rational{Int64}, Base.Rational{Int64}, Int64}})
precompile(Tuple{typeof(Base.length), Array{Base.Rational{Int64}, 1}})
...
precompile(Tuple{typeof(Printf.gen), String})
precompile(Tuple{typeof(Printf._printf), String, Expr, String, Tuple{Expr}})
...
precompile(Tuple{getfield(Tanking, Symbol("#main_simulate##kw")), NamedTuple{(:do_simulation, :num_replications, :do_plotting, :num_steps, :math_elim_mode, :gamma, :results_dir, :selected_steps), Tuple{Bool, Int64, Bool, Int64, Int64, Float64, String, String}}, typeof(Tanking.main_simulate)})
precompile(Tuple{typeof(Main.main), String})
precompile(Tuple{typeof(Random.make_seed), Int64})
precompile(Tuple{typeof(Random.seed!), Int64})
precompile(Tuple{getfield(Tanking, Symbol("#33#36")), Char})
precompile(Tuple{typeof(Base.filter), getfield(Tanking, Symbol("#33#36")), String})
...
precompile(Tuple{typeof(Tanking.set_mode), Tanking.MODE_TYPES, String})
...
precompile(Tuple{getfield(Tanking, Symbol("##main_simulate#38")), Bool, Int64, Bool, Tanking.MODE_TYPES, String, Int64, Int64, Float64, Int64, String, typeof(Tanking.main_simulate)})
...
precompile(Tuple{typeof(Tanking.simulate), Int64, Int64, Int64, Int64, Int64, Float64, Array{Base.Rational{Int64}, 1}, Array{Array{Float64, 1}, 1}, Array{Int64, 1}, Array{Int64, 1}, Tanking.MODE_TYPES, Int64, String, Bool})
